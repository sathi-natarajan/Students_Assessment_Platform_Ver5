...
@Code
    ViewData("Title") = "Bulk-create Teachers"
End Code
...
<div class="row" style="padding-top:100px;">
    ...
    <div class="col-lg-9">
     <h3>CREATE A SET OF TEACHER ACCOUNTS</h3>
     <hr style="background-color:cadetblue;height:2px;" />
        @Using (Html.BeginForm("ImportExcel", "AdminTeachers", FormMethod.Post, New With {.enctype = "multipart/form-data"}))
        ...
        @<table>
            <tr>
                <td>
                    <ol>
                        <li>
                            Create an excel spreadsheet with rows of entries one for each teacher.  For simplicity, please call it
                            <strong>Teachers.xls</strong>
                        </li>
                        <li>
        ...
        @Using (Html.BeginForm("BulkCreateTeachers", "AdminTeachers"))
        @Html.AntiForgeryToken()
        @Html.Label("Total # of teachers records to upload: ")@Model.Count@<br />
        @<table class="table">
            <colgroup>
                <col />
                <col />
