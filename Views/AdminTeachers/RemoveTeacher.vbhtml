            ...
            @<table border="0" cellpadding="2" cellspacing="2">
                ...
                <tr>
                    <td colspan="2" style="text-align:center;">
                        ...
                        <input type="button" id="Back" name="Back" value="Back" style="background:cadetblue;" Class="btn btn-success clsbutton-round" onclick="location.href='@Url.Action("Index", "Home")'" />
