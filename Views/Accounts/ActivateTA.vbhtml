@Code
    ViewData("Title") = "Activate/Deactivate Teacher Account"
End Code
...
<script type="text/javascript">
    jQuery(function ($) {
        var serviceURL = '/Accounts/GetTeacherAcctData'; //This should not be inside AJAX call itself
    ...
    function LoadTeacherActiveStatus() {
    ...
    function successFunc(data, status) {
        ...
        if (data.isActive == true)
            $("#btnSubmit").val("DE-ACTIVATE TEACHER");
        else
            $("#btnSubmit").val("ACTIVATE TEACHER");
    }
...
<div class="row" style="padding-top:100px;">
    ...
    <div class="col-lg-9">
        @Using (Html.BeginForm())
            ...
            @<h3>ACTIVATE/DEACTIVATE TEACHER ACCOUNT</h3>
            @<hr style="background-color:cadetblue;height:2px;" />
            @<table border="0" cellpadding="7" cellspacing="7">
                ...
                <tr>
                    ...
                    <td>
                        @Html.DropDownListFor(Function(model) model.SelectedTeacher, Model.TeachersList, New With {.onchange = "LoadTeacherActiveStatus();"})
