...
<script type="text/javascript">
    jQuery(function ($) {
        ...
        var serviceURL = '/TeachersStudents/GetStudentData'; //This should not be inside AJAX call itself
        ...
        if (iSel > 0) {
            ...
            $("#divStatusMessage").text("No students are available in system.  Please inform your administrator")
    ...
    function errorFunc() {
        alert('Problem while loading details for this student.  Please inform administrator.');
    }
</script>
        ...
        @Using (Html.BeginForm())
            ...
            @<table border="0" cellpadding="7" cellspacing="7">
                ...
                <tr>
                    ...
                    <td>
                        @Html.DropDownListFor(Function(model) model.SelectedStudent, Model.StudentsList, New With {.onchange = "LoadStudentDetails();"})
                ...
                <tr>
                    <td colspan="2" style="text-align:center;">
                        <input type="submit" value="UPDATE STUDENT" class="btn btn-success clsbutton-round" style="background:cadetblue;" />
