@Code
    ViewData("Title") = "Add subjects to a course"
End Code
...
<div class="row" style="padding-top:100px;">
    ...
    <div class="col-lg-9">
        @Using (Html.BeginForm())
            ...
            @<h3>ADD SUBJECTS TO A COURSE</h3>
            @<hr style="background-color:cadetblue;height:2px;" />
            @<table border="0" cellpadding="2" cellspacing="2">
                ...
                @if Model.lstTaughtCoursesForDDL.Count()>0
                    @<tr>
                        <td colspan="2">
                            @Html.Label("You are teaching these classes.  Please select a class to which you want to add more subjects", htmlAttributes:=New With {.class = "control-label col-md-2", .style = "width:100%;"})
                        </td>
                    </tr>
                    @<tr>
                        <td colspan="2">
                    ...
                    @<tr>
                        <td colspan="2">
                            @Html.Label("Select a subject to add to selected class", htmlAttributes:=New With {.class = "control-label col-md-2", .style = "width:100%;"})
                            @Html.DropDownListFor(Function(model) model.Subjects.SelectedSubject, Model.lstSubjectsForDDL, htmlAttributes:=New With {.class = "control-label col-md-2", .style = "width:100%;"})
                    ...
                    @<tr>
                        <td colspan="2" style="text-align: center;">
                            <input type="submit" value="ADD SUBJECT" Class="btn btn-success clsbutton-round" style="background:cadetblue;" />
