...
@Using (Html.BeginForm("CreateQuestion", "Questionbank"))
    ...
    @<table border="0" cellpadding="5" cellspacing="5">
        ...
        <tr>
            ...
            <td colspan="2">
                @Html.TextAreaFor(Function(model) model.QuestionStem, New With {.htmlAttributes = New With {.class = "form-control"}, .style = "width:250px;height:100px;", .maxlength = "250"})
