    ...
    <div class="col-lg-9">
        @Using (Html.BeginForm())
            ...
            @<table border="0" cellpadding="5" cellspacing="5">
                ...
                <tr>
                    <td colspan="2">
                        Please use the below area to change other parameters of this question (answers, question type, etc.)
                    </td>
                </tr>
                <tr>
                    <td>
                        @Html.Label("SELECT A STANDARD:", htmlAttributes:=New With {.class = "control-label col-md-2", .style = "width:100%;"})
                ...
                <tr>
                    <td>
                        @Html.Label("SELECT A QUESTION TYPE:", htmlAttributes:=New With {.class = "control-label col-md-2", .style = "width:100%;"})
                    </td>
                    <td>
                ...
                <tr>
                    <td colspan="2">
                        Please modify the above <strong>question stem</strong> by providing the <strong>question stem</strong> below (250 chars max.):
                    </td>
                </tr>
                <tr>
                    @*<td>
                    ...
                    <td colspan="2">
                        @Html.TextAreaFor(Function(model) model.QuestionStem_Updated, New With {.htmlAttributes = New With {.class = "form-control"}, .style = "width:500px;height:100px;", .maxlength = "250"})
                        @Html.ValidationMessageFor(Function(model) model.QuestionStem_Updated, "", New With {.class = "text-danger"})
                    </td>
                </tr>
            </table>
            ...
            @<table border="0" cellpadding="2" cellspacing="2">
                <tr>
                    <td colspan="2" style="text-align:center;">
                        <input type="submit" value="UPDATE QUESTION" Class="btn btn-success clsbutton-round" style="background:cadetblue;" />
